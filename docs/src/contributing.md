...
You can suggest features, enhancements, or report bugs on our [issue tracker](https://github.com/os4d/jmespath-filters/issues).
...
* Clone the repository:
    ```bash
    # using HTTPS
    git clone https://github.com/os4d/jmespath-filters.git

    # using SSH
    git clone git@github.com:os4d/jmespath-filters.git
    ```
